...
HD_PWD='C:/Users/innfe/Proiect_SSC/AES_Encrypted_HoneyPot/AES_Encrypted_HoneyPot.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_test_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_test_1_wrapper.tcl -notrace
