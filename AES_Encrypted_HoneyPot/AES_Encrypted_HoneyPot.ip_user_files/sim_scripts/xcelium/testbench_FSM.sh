...
#
# Script generated by Vivado on Mon Nov 18 16:17:07 +0200 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : testbench_FSM.sh
...
#
# Usage        : testbench_FSM.sh
#                testbench_FSM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                testbench_FSM.sh [-reset_run]
#                testbench_FSM.sh [-reset_log]
#                testbench_FSM.sh [-help]
#
...
#                script (type 'testbench_FSM.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "testbench_FSM.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./testbench_FSM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../AES_Encrypted_HoneyPot.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../AES_Encrypted_HoneyPot.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.testbench_FSM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.testbench_FSM -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log testbench_FSM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./testbench_FSM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: testbench_FSM.sh [-help]\n\
Usage: testbench_FSM.sh [-step]\n\
Usage: testbench_FSM.sh [-lib_map_path]\n\
Usage: testbench_FSM.sh [-reset_run]\n\
Usage: testbench_FSM.sh [-reset_log]\n\
Usage: testbench_FSM.sh [-keep_index]\n\
Usage: testbench_FSM.sh [-noclean_files]\n\n\
