...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../AES_Encrypted_HoneyPot.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../AES_Encrypted_HoneyPot.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.testbench_FSM xil_defaultlib.glbl -o testbench_FSM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./testbench_FSM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key testbench_FSM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc testbench_FSM_simv.daidir vcs_lib c.obj)
