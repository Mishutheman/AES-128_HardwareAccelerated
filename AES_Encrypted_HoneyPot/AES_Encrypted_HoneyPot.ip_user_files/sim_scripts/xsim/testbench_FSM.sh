...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xilinx_vip -L xil_defaultlib -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot testbench_FSM xil_defaultlib.testbench_FSM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim testbench_FSM -key {Behavioral:sim_1:Functional:testbench_FSM} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb testbench_FSM.wdb xsim.dir libdpi.so)
