...
#ifndef _design_test_1_xlconcat_0_1_core_h_
#define _design_test_1_xlconcat_0_1_core_h_
...
class design_test_1_xlconcat_0_1_core : public sc_module 
{
    public: 
       design_test_1_xlconcat_0_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(design_test_1_xlconcat_0_1_core);
    ...
    virtual ~design_test_1_xlconcat_0_1_core() = default;
   
    void concate_input_port_values()
    {
        sc_bv <128> portConcateVal;
